...
export function Gui({animList}) {
    ...
    return (
        <div
            id="GUI"
            className="  font-poppins font-normal text-[20px] py-4 px-4 bg-gray-gradient flex flex-col text-white rounded-md border-solid border-2 border-black-600 w-60 h-screen"
            >
