...
const Navbar = () => {
    ...
    return (
        <nav className="navbar w-full flex-1 py-2 justify-between items-center ">
            <ul className="list-none sm:flex hidden justify-end items-center flex-1 mx-24">
                ...
                {navLinks.map((nav, index) => (
                    ...
                    ${
                        index === 1 ? (
                            <link to="/https://www.linkedin.com/in/shezaad-jiffry-4b7950238/" />
                        ) : (
                            ' mr-0'
                        )
                    }`}
            ...
            <div className="sm:hidden flex flex-1 justify-end items-center mr-5 menu py-1 w-full">
                ...
                <div
                    className={`${
                        toggle ? 'flex' : 'hidden'
                    } p-6 bg-black-gradient-2 absolute top-20 min-w-[140px] rounded-xl sidebar`}
                >
